...
[![Release](https://img.shields.io/badge/version-1.2.1-blue.svg)](CHANGELOG.md)
...
| | |
| --- | --- |
| Status | **v1.2.1 — configurable OAuth + REST rate limits, reverse-proxy-aware OAuth throttling** |
